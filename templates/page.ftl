<#include "header.ftl">
  ...
  <div class="row">
    <div class="col-md-12 mt-1">
      <span class="float-xs-right">
        ...
        <button class="btn btn-outline-warning"
                ...
                data-target="#editor" aria-expanded="false"
    ...
    <div class="col-md-12 collapsable collapse clearfix"
         id="editor">
      <form action="/save" method="post">
        <div class="form-group">
          ...
          <textarea class="form-control" id="markdown"
                    name="markdown" rows="15">${context.rawContent}</textarea>
        </div>
        <button type="submit" class="btn btn-primary">Save
        </button>
        <#if context.id != -1>
          <button type="submit" formaction="/delete"
                  class="btn btn-danger float-xs-right">
            Delete
          </button>
        </#if>
      </form>
